        ...
        if (details.url.startsWith(detailsUrlPattern)) {
            ...
            for (let courseInfo of courseInfoList) {
                ...
                if(courseInfo.source == "calc" && courseInfo.gpa >= 0){
                    ...
                    course.scoreMappingId = (courseInfo.ename.includes("AP")||courseInfo.ename.includes("AS")||courseInfo.ename.includes("A2")||courseInfo.ename.includes("ALevel")||courseInfo.ename.includes("A Level"))? 6799:4517;
                    course.subjectId = courseInfo.subjectId;
