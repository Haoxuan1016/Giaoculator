...
document.getElementById('btn-read').addEventListener('click', function(){
    window.open('https://g2h8ru7041.feishu.cn/docx/O4ledp0Z4oiDxRxcwkOctUCVnOc?from=from_copylink');
});

function initSettings(){
    const homeSrc = "https://bing.biturl.top/?resolution=3840&format=image&index=0&mkt=zh-CNN";
...
function exit(){
    window.close();     
    window.open('https://tsinglanstudent.schoolis.cn', '_blank');
}
